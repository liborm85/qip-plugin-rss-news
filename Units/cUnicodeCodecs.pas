...
function  DetectUTF16BEBOM(const P: PAnsiChar; const Size: Integer): Boolean;
function  DetectUTF16LEBOM(const P: PAnsiChar; const Size: Integer): Boolean;
function  DetectUTF16BOM(const P: PAnsiChar; const Size: Integer;
...
function  GetEncodingName(const CodecClass: TUnicodeCodecClass): AnsiString;
...
procedure RaiseUnicodeCodecException(const Msg: AnsiString; const Args: array of const;
    const ProcessedBytes: Integer); overload;
var E : EUnicodeCodecException;
begin
