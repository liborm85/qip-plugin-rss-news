...
type
  ...
  TStaticStringArray = Array[0..MaxStringArrayElements - 1] of AnsiString;
...
function PosNext(const Find: AnsiString; const V: StringArray; const PrevPos: Integer;
    const IsSortedAscending: Boolean): Integer;
var I, L, H : Integer;
    D       : AnsiString;
begin
